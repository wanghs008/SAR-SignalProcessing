...
% 绘图
H7 = figure;
set(H7,'position',[100,100,900,900]);
subplot(331),plot(QPE/pi,(IRW1-IRW1(1))/IRW1(1)*100)
title('(a)IRW'),xlabel('|QPE|(\pi弧度)'),ylabel('展宽百分比')
subplot(332),plot(QPE/pi,fftshift(PSLR1))
title('(b)PSLR'),xlabel('|QPE|(\pi弧度)'),ylabel('PSLR/dB')
subplot(333),plot(QPE/pi,ISLR1)
title('(c)ISLR'),xlabel('|QPE|(\pi弧度)'),ylabel('ISLR/dB')
subplot(334),plot(QPE/pi,(IRW2-IRW2(1))/IRW2(1)*100)
title('(a)IRW'),xlabel('|QPE|(\pi弧度)'),ylabel('展宽百分比')
subplot(335),plot(QPE/pi,fftshift(PSLR2))
title('(b)PSLR'),xlabel('|QPE|(\pi弧度)'),ylabel('PSLR/dB')
subplot(336),plot(QPE/pi,ISLR2)
title('(c)ISLR'),xlabel('|QPE|(\pi弧度)'),ylabel('ISLR/dB')
subplot(337),plot(QPE/pi,(IRW3-IRW3(1))/IRW3(1)*100)
title('(a)IRW'),xlabel('|QPE|(\pi弧度)'),ylabel('展宽百分比')
subplot(338),plot(QPE/pi,fftshift(PSLR3))
title('(b)PSLR'),xlabel('|QPE|(\pi弧度)'),ylabel('PSLR/dB')
subplot(339),plot(QPE/pi,ISLR3)
title('(c)ISLR'),xlabel('|QPE|(\pi弧度)'),ylabel('ISLR/dB')
